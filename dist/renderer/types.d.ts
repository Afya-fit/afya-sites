...
export type ScheduleSection = {
    ...
    title?: string;
    windowDays?: number;
    viewMode?: 'stacked' | 'single_day';
};
export type SectionUnion = HeroSection | ContentBlockSection | BusinessDataSection | SpecialOffersSection | LinksPageSection | ScheduleSection;
